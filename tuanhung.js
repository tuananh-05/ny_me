const yourDate = new Date("Aug 15, 2023 00:00:00");
...
var hung = calculate_age(new Date(2005, 10, 20));
var nhi = calculate_age(new Date(2005, 9, 9));
var h = document.getElementById('tuan_hung');
var n = document.getElementById('phuong_nhi');
